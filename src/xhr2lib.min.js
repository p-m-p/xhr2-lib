...
100*Math.round(a.loaded/a.total))},n=function(a,b,c){var d;switch((b||"").toLowerCase()){case "json":b="application/json, text/javascript, ";break;case "xml":b="text/xml, application/xml, ";break;case "text":b="text/plain, ";break;default:b="text/html, "}a.setRequestHeader("Accept",b+"*/*;q=0.01");a.setRequestHeader("X-Requested-With","XMLHttpRequest");if("object"===typeof c)for(d in c)c.hasOwnProperty(d)&&a.setRequestHeader(d,c[d])},l=function(a){var a=a.target,b;a&&(b=k(a))&&b.call(a,a.statusText,
a.status)},k=function(a){if(a.xhr2data&&"function"===typeof a.xhr2data.error)return a.xhr2data.error;if(h)return h};return d}()})(self||window);