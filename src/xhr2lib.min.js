...
setTimeout(function(){var a=b,c=l(a);a.abort();c&&c.call(void 0,{message:"Request timed out",type:"XHR2RequestTimeout"},"timeout",a.status);b=void 0;b=null},c.timeout);b.open(c.type,c.url,c.async,c.username,c.password);b.withCredentials=c.withCredentials;o(b,c.dataType,c.headers);b.xhr2data=c;b.onreadystatechange=p;b.onerror=m;b.send(c.data);return b};e.serialize=function(a,b){var d="";b&&"string"===typeof b?d=-1===b.indexOf("?")?"?":"&":b="";if("object"===typeof a)for(var c in a)a.hasOwnProperty(c)&&
(d+=c+"="+a[c]+"&");return b+d.substr(0,d.length-1)};e.isTypeOf=function(a,b){var d=a.constructor.toString().toLowerCase(),b=b.replace(/^\s*|\s*$/,"").toLowerCase();return-1!==d.indexOf(b)?!0:!1};var f=function(a){for(var b=0,d={url:a[0]},a=Array.prototype.slice.call(a,1),c=!1;b<a.length;++b)switch(typeof a[b]){case "string":d.dataType=a[b];break;case "function":c?d.progress=a[b]:(d.success=a[b],c=!0);break;case "object":d.data=a[b]}return d},g=function(){var a={},b=0,d;if(arguments.length&&"undefined"!==
typeof arguments[0])for(;b<arguments.length;++b)for(d in arguments[b])arguments[b].hasOwnProperty(d)&&(a[d]=arguments[b][d]);return a},p=function(a){var b,d=a.target,c=d.xhr2data||{},e;if(d.readyState===d.DONE)switch(e=Math.round(d.status/100),c.timer&&clearTimeout(c.timer),e){case 2:a=c&&c.success?c.success:k?k:void 0;if("function"===typeof a){if("json"===c.dataType)try{b=JSON.parse(d.responseText)}catch(f){}else b="xml"===c.dataType?d.responseXML:d.responseText;a.call(d,b)}break;case 4:case 5:m(a)}},
n=function(a){a&&a.lengthComputable&&a.target.callback.call(a,100*Math.round(a.loaded/a.total))},o=function(a,b,d){var c;switch((b||"").toLowerCase()){case "json":b="application/json, text/javascript, ";break;case "xml":b="text/xml, application/xml, ";break;case "text":b="text/plain, ";break;default:b="text/html, "}a.setRequestHeader("Accept",b+"*/*;q=0.01");a.setRequestHeader("X-Requested-With","XMLHttpRequest");if("object"===typeof d)for(c in d)d.hasOwnProperty(c)&&a.setRequestHeader(c,d[c])},m=
function(a){var a=a.target,b;a&&(b=l(a))&&b.call(a,a.statusText,a.status)},l=function(a){if(a.xhr2data&&"function"===typeof a.xhr2data.error)return a.xhr2data.error;if(j)return j};return e}()})(window);
